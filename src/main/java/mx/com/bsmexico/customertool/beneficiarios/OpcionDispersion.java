...
public class OpcionDispersion extends Feature {
	...
	public Layout getLayout() {
		...
		NavRoute route = null;
		try {
			route = navRuoteBuilder.addNode("Generacion de Archivos de Entrada", "Generacion de Archivos de Entrada",0,false,getImageInput("/img/archivos.png",100,100)).addNode("Dispersion de Pagos", "Dispersion de Pagos",0,false,getImageInput("/img/dispersion.png",100,100)).build();
	...
	public void launch() {
		...
		Label label = new Label("Estoy en la opcion de dispersion");
