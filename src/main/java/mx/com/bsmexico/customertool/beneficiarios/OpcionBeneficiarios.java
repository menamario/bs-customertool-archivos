...
public class OpcionBeneficiarios extends Feature {
	...
	public Layout getLayout() {
		...
		NavRoute route = null;
		try {
			route = navRuoteBuilder.addNode("Generacion de Archivos de Entrada", "Generacion de Archivos de Entrada",0,false,getImageInput("/img/archivos.png",100,100)).addNode("Alta de Beneficiarios", "Alta de Beneficiarios",0,false,getImageInput("/img/beneficiarios.png",100,100)).build();
